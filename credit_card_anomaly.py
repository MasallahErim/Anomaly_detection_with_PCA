...
# Veriseti
df = pd.read_csv("C:\\Users\\Maşallah\\Desktop\\Deeplearning\\for_github\\anomaly-pca\\data\\creditcard.csv")
df_class = df["Class"]
del df["Class"]
del df["Time"]
...
# oluşan hataların belli bir eşit değerden sonraki verilerin indexlerini alma
